...
def compute_corpus_bleu(hypothesis, references):
...
def compute_individual_bleu(ref, hyp):
...
if __name__ == "__main__":
    hype = "The cat the cat on the mat"
    refs = ["The cat is on the mat","There is a cat on the mat"]
    scores = compute_individual_bleu(refs,hype)
    print(scores)